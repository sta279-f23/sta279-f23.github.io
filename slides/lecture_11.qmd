---
title: "Lecture 11: Rectangular data"
format: 
  revealjs:
    theme: theme.scss
editor: source
...
## Content so far (in R and Python!)

* Simulation
* Iteration
* Vectors (R), 1-d arrays (Python), and lists
* Functions
...
* Tibbles are special types of data frames, often used in tidyverse packages


## Class activity

[https://sta279-f23.github.io/class_activities/ca_lecture_11.html](https://sta279-f23.github.io/class_activities/ca_lecture_11.html)
