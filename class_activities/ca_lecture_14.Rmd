...
**Instructions:** Work with a neighbor to answer the following questions. To get started, download the [class activity template](https://sta279-f23.github.io/class_activities/ca_lecture_14_template.qmd) file.
...
3. Using `".value"` in the `names_to` argument of the `pivot_longer` function, reshape the `household` data to look like this:
