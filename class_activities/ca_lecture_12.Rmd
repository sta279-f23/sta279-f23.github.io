...
**Instructions:** Work with a neighbor to answer the following questions. To get started, download the [class activity template](https://sta279-f23.github.io/class_activities/ca_lecture_12_template.qmd) file.
...
8. Using your plots summary statistics, describe the relationship between GDP per capita and life expectancy, and summarize the differences between continents.
